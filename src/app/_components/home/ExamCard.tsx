// Doubt: I removed "use client" from this component. Is this still client component or server
...
export default function ExamCard({
  ...
  return(
      // TODO: When pressing space or entering after focusing the button using tab, nothing happens
      <button
        type="button"
      ...
      >
        <p className="font-display text-2xl font-bold tracking-[0.18em] text-white sm:text-3xl">{displayName}</p>
      </button>
  )
}
