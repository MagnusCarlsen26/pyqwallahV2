    ...
    <main className="relative isolate flex min-h-screen overflow-hidden bg-background text-center">
      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col items-center justify-center px-6 py-16">
        {!isVantaLoaded ? <PropagateLoader color="#cad5e2" /> :
          <>
            <h1 className="mb-10 bg-linear-to-r from-lime-300 via-green-400 to-white bg-clip-text font-display text-5xl font-extrabold tracking-[0.18em] text-transparent drop-shadow-[0_0_30px_rgba(57,255,20,0.35)] sm:text-6xl lg:text-7xl">
              PYQ WALLAH
            </h1>
            <p className="mb-14 max-w-2xl text-base text-slate-300 sm:text-lg lg:text-xl">
